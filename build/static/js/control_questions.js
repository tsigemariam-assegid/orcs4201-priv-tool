// static/js/control_questions.js
$(document).ready(() => {
  const $container   = $('#questions-container');
  const category     = $container.data('category');      // "Control"
  const introUrl     = $container.data('intro-url');     // "/control"
  const completeUrl  = $container.data('complete-url');  // "/communicate"
          ...
          <div class="question-box">
            <div class="question-content">
              ...
              <button class="next-btn">
                ${qIdx === total - 1 ? 'Finish Control' : 'Next'}
              </button>
            </div>
