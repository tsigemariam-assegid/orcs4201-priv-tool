// static/js/communicate_questions.js
$(document).ready(() => {
  const $container   = $('#questions-container');
  const category     = $container.data('category');      // "Communicate"
  const introUrl     = $container.data('intro-url');     // "/communicate"
  const completeUrl  = $container.data('complete-url');  // "/protect"
          ...
          <div class="question-box">
            <div class="question-content">
              ...
              <button class="next-btn">
                ${qIdx === total - 1 ? 'Finish Communicate' : 'Next'}
              </button>
            </div>
